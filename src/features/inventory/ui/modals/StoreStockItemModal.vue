...
interface Props {
  editingItem: StoreStockItem | null
  editForm: EditForm
}
    ...
    <div class="w-full max-w-md rounded-2xl border border-gray-800 bg-gray-950 p-6 shadow-2xl space-y-4">
      <div class="flex items-center justify-between border-b border-gray-800 pb-3">
        <div class="flex items-center gap-2">
          ...
          <h3 class="text-base font-semibold text-gray-100">Редактирование системного остатка</h3>
        </div>
        <button
          type="button"
          @click="emit('close')"
      ...
      <div class="space-y-3 text-xs">
        ...
        <div>
          <label class="block text-gray-400 mb-1 font-medium">Количество *</label>
          <input
