...
const emit = defineEmits<{
  (e: 'toggle'): void
  (e: 'deduplicate'): void
  (e: 'removeNonStandard'): void
  (e: 'removeFiltered'): void
  (e: 'copyFiltered'): void
  (e: 'copySelected'): void
}>()
</script>
...
<template>
  <div v-if="!isReadOnly" id="catalog-mass-actions-menu-wrapper" class="relative">
    <button
      type="button"
      ...
      title="Массовые операции с товарами каталога"
    >
      <span>⚡</span>
